...
const Preferences = {
    ...
    THEMES: {
        // Тема «Академия Образцовой» — тёмно-синяя с золотым акцентом
        akademia: {
            type: 'Akademia',
            sidebarBg: '#1a1a35',
            sidebarText: '#f0ead6',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#2a2a50',
            sidebarTextActiveBorder: '#c4973b',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#12122a',
            sidebarHeaderTextColor: '#f0ead6',
            sidebarTeamBarBg: '#0d0d20',
            ...
            centerChannelColor: '#2c2c3e',
            newMessageSeparator: '#c4973b',
            linkColor: '#8b6914',
            buttonBg: '#1a1a35',
            buttonColor: '#f0ead6',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#ffeaa0',
            mentionHighlightLink: '#1a1a35',
            codeTheme: 'github',
        },
        denim: {
            type: 'Denim',
