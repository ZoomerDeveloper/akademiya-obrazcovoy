...
const holders = defineMessages({
    ...
    academyRole: {
        id: 'user.settings.general.academyRole',
        defaultMessage: 'Academy Role',
    },
});
...
export class UserSettingsGeneralTab extends PureComponent<Props, State> {
    getAcademyRoleLabel = () => {
        ...
        if (roles.includes('system_admin')) {
            return this.props.intl.formatMessage({
                id: 'user.settings.general.academyRole.system_admin',
                defaultMessage: 'Администратор Академии',
            });
        }
        if (roles.includes('team_admin')) {
            return this.props.intl.formatMessage({
                id: 'user.settings.general.academyRole.staff',
                defaultMessage: 'Педагог / Сотрудник',
            });
        }
        return this.props.intl.formatMessage({
            id: 'user.settings.general.academyRole.student',
                ...
                extraInfo = (
                    <span>
                        <FormattedMessage
                            ...
                            defaultMessage='Укажите роль/должность в Академии (например: «Педагог фортепиано», «Студент, курс 2», «Менеджер приёмной»). Поле отображается в профиле и помогает быстрее находить нужного человека.'
                        />
                    </span>
                );
        ...
        if (user.position) {
            ...
            describe = (
                <FormattedMessage
                    ...
                    defaultMessage="Нажмите 'Edit', чтобы добавить роль / должность в Академии"
                />
            );
            if (this.props.isMobileView) {
                describe = (
                    <FormattedMessage
                        ...
                        defaultMessage='Нажмите, чтобы добавить роль / должность в Академии'
                    />
                );
            }
        }
    ...
    render() {
        ...
        const academyRole = this.getAcademyRoleLabel();
        ...
        return (
            ...
            >
                ...
                <div className='user-settings'>
                    ...
                    />
                    <div className='setting-list__hint pb-2'>
                        <strong>
                            <FormattedMessage
                                id='user.settings.general.academy.profileCardTitle'
                                defaultMessage='Профиль Академии'
                            />
                        </strong>
                        <div>
                            <FormattedMessage
                                id='user.settings.general.academy.roleLine'
                                defaultMessage='Роль: {role}'
                                values={{role: academyRole}}
                            />
                        </div>
                        <div>
                            <FormattedMessage
                                id='user.settings.general.academy.loginLine'
                                defaultMessage='Логин: @{username}'
                                values={{username: this.props.user.username}}
                            />
                        </div>
                        <div>
                            <FormattedMessage
                                id='user.settings.general.academy.emailLine'
                        ...
                        <div style={{marginTop: 6}}>
                            <FormattedMessage
                                id='user.settings.general.academy.recommendation'
                                defaultMessage='Рекомендуем заполнить поле Position и дополнительные атрибуты (направление, группа, педагог), чтобы профиль был информативным для учебной работы.'
                            />
                        </div>
                    </div>
