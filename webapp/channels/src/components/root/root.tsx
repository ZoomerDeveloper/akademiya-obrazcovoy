...
const SmsLoginPage = makeAsyncComponent('SmsLoginPage', lazy(() => import('components/login/sms_login_page')));
...
const AcademyHub = makeAsyncComponent('AcademyHub', lazy(() => import('components/academy/hub')));
const AcademyConsentBanner = makeAsyncComponent('AcademyConsentBanner', lazy(() => import('components/academy/academy_consent_banner')));
