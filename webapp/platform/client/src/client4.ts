...
export default class Client4 {
    ...
    getOptions(options: Options) {
        ...
        // Явно задаём режим: иначе у fetch по умолчанию «same-origin» — для запросов на тот же host
        // браузер всё равно прикрепляет cookies, и Mattermost предпочитает MMAUTHTOKEN перед Authorization.
